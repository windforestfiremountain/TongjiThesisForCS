% \documentclass[degree=master, degreetype=academic, bibtype=numeric, newstyle=true]{tongjithesis}  %双面打印
...
\usepackage{bm}
\usepackage{hyperref}
\usepackage{tabularx, booktabs, makecell, array,multirow}
\usepackage{ragged2e}
\usepackage{amsmath}
...
\newcommand{\codeurl}[2]{%
  \footnote{\href{#1\#L#2}{Github参考代码, 第 #2行}}%    % 如果footnote放链接，可以参考此command
}
