...
\section{PPT预答辩稿准备}
\label{sec:intro:ppt}
可以使用GeminiPro等大模型，喂给他你的**chap.0x.tex**文件，自己调教一个Prompt，让他逐页生成PPT需要的内容，例如“请结合这个tex文件概括本文研究动机”，。PPT成稿后，可用Prompt生成预答辩稿。例如假设你xxx领域颇有研究，正准备对“xx”中国硕士论文课题预答辩，正在做ppt，请帮我”
