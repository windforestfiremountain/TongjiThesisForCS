...
\section{PPT预答辩稿准备}
\label{sec:intro:ppt}
可以使用GeminiPro等大模型，喂给他你的**chap.0x.tex**文件，自己调教一个Prompt，让他逐页生成PPT需要的内容，例如“根据chap04.tex概括研究动机，用于ppt的制作”，“进一步，参考这章ppt内容，基于chap05.tex的内容，写一个问题定义的ppt一页介绍”等。PPT成稿后，可用Prompt生成预答辩稿。例如假设你xxx领域颇有研究，正准备对“xx”中国硕士论文课题预答辩，正在做ppt，请帮我”
